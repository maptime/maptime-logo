...
function maptimeLogo(id) {
    var global = window;
    var requestInterval, cancelInterval;
    var encoder = new GIFEncoder();
    encoder.setRepeat(0); //auto-loop
    encoder.setSize(700, 200);
    ...
    function render() {
        ...
        ctx.font = 'normal 130px Comfortaa';
        ...
        encoder.finish();
        document.getElementById('logo-gif').src = 'data:image/gif;base64,' + encode64(encoder.stream().getData());
        ...
        function frame() {
            ...
            for (var i = 0; i < 6; i++) {
                ...
                ctx.fillText('#maptime!', 10 + off, 120 + off);
            }
            colors();
